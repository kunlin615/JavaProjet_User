...
import main.MyMainFrame;

/**
 * Cette classe est la classe principale de l'application. Elle crée les
 * contrôleurs d'utilisateurs et d'emplois de temps ainsi que l'interface
 * graphique (MainFrame).
 * 
